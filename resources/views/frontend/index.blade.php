...
@section('body')
  <!-- slider-area -->
   @include('frontend.home_page.home_slider.slider')
           ...
           <!-- pricing-area -->
           @include('frontend.home_page.gallery.gallery')
            <!-- pricing-area-end -->
            <!-- counter-area -->
                      ...
                      <div class="col-lg-5 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-2 col-md-12 col-sm-12">
                            <div class="slider-btn mt-130">
                                <a href="{{route('get.appointment')}}" class="btn ss-btn" data-animation="fadeInRight" data-delay=".8s">Appointment <i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
